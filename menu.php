...
<?php }
/*
 * Opcje dost�pne przy niezalogowanym u�ytkowniku
 * PDF: Stwardnienie Rozsiane
 * PDF: O Rejestrze
 * Opcja: zarejestruj si� 
 */
...
<!-- Strza�ka pokazuj�ca/chowaj�ca menu po lewej stronie -->     
...
<!-- Opcja wyloguj - dost�pna tylko przy zalogowanym u�ytkowniku -->
<?php if ((isset($_SESSION['login'])) && (isset($_SESSION['logged_in'])))
{
?>    
        <li class="nav-item">
...
<!-- Opcja zaloguj - dost�pna tylko przy niezalogowanym u�ytkowniku -->
<?php if ((!isset($_SESSION['login'])) && (!isset($_SESSION['logged_in'])))
{
?>    
        <li class="nav-item">
...
<!-- Container (bia�e t�o do tekstu), koniec diva na pocz�tku pliku pages/footer.php -->
  <div class="card mb-3">
