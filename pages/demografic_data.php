...
<div class="card mb-3" id="DemograficTable">
<div class="card-header"><h5>
     <i class="fa fa-address-card-o"></i> <?php echo $demografic_data;?></h5>
</div></div>
<div class="card-body">
...
require_once '../form/form_demografic_query.php';
// okno formularza 
require_once '../form/form_demografic.php'; 
?>
